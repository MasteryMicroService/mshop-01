...
<title>我的信息 - 远通</title>
<meta name="Keywords" content="java,远通java" />
<meta name="description" content="在远通中找到了29910件java的类似商品，其中包含了“图书”，“电子书”，“教育音像”，“骑行运动”等类型的java的商品。" />
    ...
    <div class="g-0">
        <div id="content" class="c-3-5">
            <div class="mod-main">
						<div class="mt">
							<ul class="extra-l">
                                <li class="fore-1"><a  href="<%=basePath%>jsp/my-info.jsp">基本信息</a></li>
                                <li class="fore-2"><a  href="<%=basePath%>jsp/my-info-img.jsp">头像照片</a></li>
                                <li class="fore-3"><a href="<%=basePath%>jsp/my-info-more.jsp">更多个人信息</a></li>
						...
						<div class="mc update-face-cont">
							<div class="update-lcol">
								<div class="mb10">
									...
									<img id="loading" class="float:left" src="<%=basePath%>images/loading.gif" style="display:none">
								...
								<div class="smc face-list">
									<ul class="imgUl">
										<li value="1"><img src="<%=basePath%>images/defaultImgs/1.jpg" alt="" width="50" height="50"><b></b></li>
										<li value="2"><img src="<%=basePath%>images/defaultImgs/2.jpg" alt="" width="50" height="50"><b></b></li>
										<li value="3"><img src="<%=basePath%>images/defaultImgs/3.jpg" alt="" width="50" height="50"><b></b></li>
										<li value="4"><img src="<%=basePath%>images/defaultImgs/4.jpg" alt="" width="50" height="50"><b></b></li>
										<li value="5"><img src="<%=basePath%>images/defaultImgs/5.jpg" alt="" width="50" height="50"><b></b></li>
										<li value="6"><img src="<%=basePath%>images/defaultImgs/6.jpg" alt="" width="50" height="50"><b></b></li>
										<li value="7"><img src="<%=basePath%>images/defaultImgs/7.jpg" alt="" width="50" height="50"><b></b></li>
										<li value="8"><img src="<%=basePath%>images/defaultImgs/8.jpg" alt="" width="50" height="50"><b></b></li>
										<li value="9"><img src="<%=basePath%>images/defaultImgs/9.jpg" alt="" width="50" height="50"><b></b></li>
										<li value="10"><img src="<%=basePath%>images/defaultImgs/10.jpg" alt="" width="50" height="50"><b></b></li>
										<li value="11"><img src="<%=basePath%>images/defaultImgs/11.jpg" alt="" width="50" height="50"><b></b></li>
										<li value="12"><img src="<%=basePath%>images/defaultImgs/12.jpg" alt="" width="50" height="50"><b></b></li>
										<li value="13"><img src="<%=basePath%>images/defaultImgs/13.jpg" alt="" width="50" height="50"><b></b></li>
										<li value="14"><img src="<%=basePath%>images/defaultImgs/14.jpg" alt="" width="50" height="50"><b></b></li>
										<li value="15"><img src="<%=basePath%>images/defaultImgs/15.jpg" alt="" width="50" height="50"><b></b></li>
										<li value="16"><img src="<%=basePath%>images/defaultImgs/16.jpg" alt="" width="50" height="50"><b></b></li>
									</ul>
									<div class="btns mt20">
							...
							<div class="update-rcol">
								...
								<div class="smc">
									...
									<div class="img-m-cont img-cont">
										<div class="img-s">
									    <img id="midImage" width="100" height="100" name="midImage" src="<%=basePath%>images/defaultImgs/1.jpg">
                                        </div>
									</div>
									100*100像素
									<div class="img-s-cont img-cont">
										<div class="img-s">
										<img id="smaImage" width="50" height="50" name="smaImage" src="<%=basePath%>images/defaultImgs/1.jpg">
                                        </div>
									</div>
									50*50像素
								</div>
